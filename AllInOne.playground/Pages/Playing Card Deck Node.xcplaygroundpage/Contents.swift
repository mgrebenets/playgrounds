...
func ==<T> (lhs: T, rhs: T) -> Bool where T: A {
...
class AA: Equatable {
    ...
    func equals<T> (other: T) -> Bool where T: AA {
        return a == other.a
    }
}

func ==<T> (lhs: T, rhs: T) -> Bool where T: AA {
    return lhs.equals(other: rhs)
}
...
class BB: AA {
    ...
    override func equals<T> (other: T) -> Bool where T : BB {
        return super.equals(other: other) && b == other.b
    }
}
...
func ==<T> (lhs: T, rhs: T) -> Bool where T: CardClass {
